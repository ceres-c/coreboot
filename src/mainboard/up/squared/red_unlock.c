...
void red_unlock_payload(void)
{
	...
	*/
	...
	while (true) {
		...
		// Unrolled loop 2048 times
		// TODO: result_a and result_b are going to be wrong when returning them, save them to other variables when detecting the glitch
		do {
			performed++;
			result_a = operand1 * operand2;
			result_b = operand1 * operand2;
			faulty_result_found += result_a != result_b;
			performed++;
			result_a = operand1 * operand2;
			result_b = operand1 * operand2;
			faulty_result_found += result_a != result_b;
