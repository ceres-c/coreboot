...
#pragma GCC optimize ("O0") /* Necessary, otherwise funny things happen with the print. TODO check if needed after print is removed */

#include "../mainboard/up/squared/lib-micro-x86/misc.h"
#include "../mainboard/up/squared/lib-micro-x86/ucode_macro.h"
#include "../mainboard/up/squared/lib-micro-x86/udbg.h"
#include "../mainboard/up/squared/lib-micro-x86/opcode.h"
#include "../mainboard/up/squared/lib-micro-x86/match_and_patch_hook.h"

#define MAGIC_UNLOCK 0x200
#define APL_UCODE_CRBUS_UNLOCK	0x1e6 // TODO this is already defined in msr.h
